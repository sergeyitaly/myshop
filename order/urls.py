...
from .views import (
    ...
    update_order, telegram_webhook, health_check, get_order_summary_by_chat_id
)
...
urlpatterns = [
    ...
    path('order_summary/<str:chat_id>/', get_order_summary_by_chat_id, name='get_order_summary_by_chat_id'),
