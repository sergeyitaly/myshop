...
if __name__ == "__main__":
    # Create an instance of LoadImagesToS3
    loader = LoadImagesToS3(name="ImageLoader")

    # Specify the local media directory
    local_media_directory = '/path/to/local/media/directory'

    # Call the method to copy local media to S3
    loader.copy_local_media_to_s3(local_media_directory)
