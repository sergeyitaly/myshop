...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'photo', 'image_tag', 'collection', 'price', 'currency', 'stock', 'available', 'sales_count', 'popularity', 'size')  # Added 'id' and 'image_tag' here
    search_fields = ['name']
    readonly_fields = ('id', 'slug', 'image_tag')
    fields = (
        'id', 'name', 'collection', 'description', 'price', 'currency', 'stock', 'available', 'sales_count',
        'popularity', 'color', 'size', 'photo', 'image_tag', 'slug'
    )
