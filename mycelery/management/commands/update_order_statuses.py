...
class Command(BaseCommand):
    help = "Update order statuses based on time periods and send notifications"
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f"Updated statuses for {len(updated_orders)} orders"))
