	...
	const postComment = async (userData: typeof data) => {
		try {
			const response = await axios.post(
				`${apiBaseUrl}/api/comments/comments/`,
				userData
			);
		...
		<PageContainer>
			...
			<div className={style.generalContainer}>
				<div className={style.contactScontainer}>
					...
					<p className={style.subTitle}>{t("phone")}</p>
					<p>
						{" "}
						<a href="tel:+380634578932">+380634578932</a>{" "}
					</p>
					...
					<p>
						{" "}
						<a href="mailto:customer@koloryt.com">
							customer@koloryt.com
						</a>{" "}
					</p>
				</div>
