...
import { FormikRadioButton } from "../../UI/FormikRadioButton/FormikRadioButton";
	...
	return (
		...
		>
			<Form className={clsx(styles.form, className)}>
				...
				<OrderFormBox title={t("delivery.label")}>
					<div className={styles.radioGroup}>
						<FormikRadioButton
							name="delivery"
							value="self_pickup"
							label={t("delivery.self_pickup")}
						/>
						<FormikRadioButton
							name="delivery"
							value="nova_poshta"
							label={t("delivery.nova_poshta")}
						/>
						<FormikRadioButton
							name="delivery"
							value="ukr_poshta"
							label={t("delivery.ukr_poshta")}
						/>
					</div>
				</OrderFormBox>

				<OrderFormBox title={t("payment.label")}>
					<div className={styles.radioGroup}>
						<FormikRadioButton
							name="payment"
							value="cash_on_delivery"
							label={t("payment.cash_on_delivery")}
						/>
						<FormikRadioButton
							name="payment"
							value="card_online"
							label={t("payment.card_online")}
						/>
					</div>
				</OrderFormBox>
